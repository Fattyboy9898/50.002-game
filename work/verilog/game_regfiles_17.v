...
module game_regfiles_17 (
    ...
    output reg [15:0] debug_out_register,
    output reg [6:0] operand1_out,
    output reg [6:0] operand2_out,
    output reg [1:0] operation_out,
    output reg [5:0] countdown_timer_out,
    output reg [6:0] score_out,
    output reg [12:0] answer_out,
    output reg [3:0] moduloAns_out,
    output reg [2:0] scoreTimter_out,
    output reg [9:0] ledvalue_out
  );
  ...
  always @* begin
    ...
    operand1_out = M_operand1_q;
    operand2_out = M_operand2_q;
    operation_out = M_operation_level_q;
    countdown_timer_out = M_countdown_timer_q;
    score_out = M_score_q;
    answer_out = M_expectedAns_q;
    moduloAns_out = M_moduloAns_q;
    scoreTimter_out = M_score_timer_q;
    ledvalue_out = M_ledvalue_q;
    debug_out_write_address = write_address;
    debug_out_ra = read_address_a;
    debug_out_rb = read_address_b;
    debug_out_register = M_countdown_timer_q;
    if (we) begin
