...
set_property IOSTANDARD LVCMOS33 [get_ports {opled}]
set_property PACKAGE_PIN K2 [get_ports {led_level}]
set_property IOSTANDARD LVCMOS33 [get_ports {led_level}]
set_property PACKAGE_PIN C1 [get_ports {nixie_a1[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {nixie_a1[0]}]
set_property PACKAGE_PIN C3 [get_ports {nixie_a1[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {nixie_a1[1]}]
set_property PACKAGE_PIN E3 [get_ports {nixie_a1[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {nixie_a1[2]}]
set_property PACKAGE_PIN D4 [get_ports {nixie_a1[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {nixie_a1[3]}]
